...
class Funcs:
    ...
    def almacenar(self):
            ...
            if self.output_col == [] or self.input_col == []:
                QMessageBox.warning(None,"Warning","Please select at least an input and an output column")
            else:
            ...
            try:
                if file_name:
                    ...
                    if file_name.endswith('.csv'):
                        ...
                        QMessageBox.warning(None, "Warning", "Unsupported file format.")
                        return
                    self.update_table(self.table_widget, self.df)  # Actualizamos la tabla al cargar el archivo
    ...
    def load_sqlite(self, file_name):
            ...
            if tables.empty:
                QMessageBox.warning(None, "Warning", "No tables found in SQLite database.")
